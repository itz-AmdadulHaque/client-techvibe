...
export default function Footer() {
  ...
  return (
    <footer id="contact" className="bg-black border-t border-neutral-700">
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 mb-12">
          ...
          <div className="space-y-5">
            ...
            <Link
              href="/about"
              className="text-lg  font-semibold text-white flex items-center gap-2 hover:text-blue-400 transition-colors underline"
            >
              <SquareArrowOutUpRight className="text-green-500 hover:text-red-500" />{" "}
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-6">
              ...
              <div className="rounded-md overflow-hidden">
                <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3690.123456789!2d91.8100!3d22.3400!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjLCsDIwJzI0LjAiTiA5McKwNDgnMzYuMCJF!5e0!3m2!1sen!2sbd!4v1234567890"
                width="100%"
                height="100%"
                style={{ border: 0 }}
        ...
        <div className="text-center pt-8 ">
          <p className="text-gray-400 text-sm">
            Developed by -{" "}
            <Link
              className="text-blue-500 font-extrabold text-xl"
